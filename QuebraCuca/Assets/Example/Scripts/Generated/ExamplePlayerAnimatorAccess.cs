...
namespace AnimatorAccess {
	...
	public class ExamplePlayerAnimatorAccess : BaseAnimatorAccess
    {
		...
		public override void InitialiseEventManager () {
            ...
            StateInfos.Add(Animator.StringToHash("Base Layer.Idle"), new StateInfo(Animator.StringToHash("Base Layer.Idle"), 0, "Base Layer", "Base Layer.Idle", "", 1f, false, false, "Idle", 2.708333f));

            Debug.Log("HASH CODE: " + animator.GetCurrentAnimatorStateInfo(0).GetHashCode());
            Debug.Log("NAME HASH: " + animator.GetCurrentAnimatorStateInfo(0).nameHash);
            Debug.Log("TAG HASH: " + animator.GetCurrentAnimatorStateInfo(0).tagHash);
            Debug.Log("IS NAME: " + animator.GetCurrentAnimatorStateInfo(0).IsName("Idle"));
            Debug.Log("TO STRING: " + animator.GetCurrentAnimatorStateInfo(0).ToString());
