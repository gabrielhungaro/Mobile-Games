...
namespace States
{
    public class GameScene : Scene
    {
        ...
        private void CreateBackground()
        {
            ...
            _leftWall3.GetComponent<UI2DSprite>().SetAnchor(_uiRoot);
            ...
            _rightWall3.GetComponent<UI2DSprite>().SetAnchor(_uiRoot);
            ...
            _floor3.GetComponent<UI2DSprite>().SetAnchor(_uiRoot);
            ...
            _leftWall2.GetComponent<UI2DSprite>().SetAnchor(_uiRoot);
            ...
            _rightWall2.GetComponent<UI2DSprite>().SetAnchor(_uiRoot);
            ...
            _floor2.GetComponent<UI2DSprite>().SetAnchor(_uiRoot);
            ...
            _leftWall1.GetComponent<UI2DSprite>().SetAnchor(_uiRoot);
            ...
            _rightWall1.GetComponent<UI2DSprite>().SetAnchor(_uiRoot);
            ...
            _floor1.GetComponent<UI2DSprite>().SetAnchor(_uiRoot);
            ...
            _roof.GetComponent<UI2DSprite>().SetAnchor(_uiRoot);
            ...
            _pointsBg.GetComponent<UI2DSprite>().SetAnchor(_uiRoot);
